...
## Current status
**Phase: pre-build / Step 4 (images).** Docs 01–11 + app docs generated & frozen; **03b APPROVED**. Image prompts generated → `docs/image-prompts.md` (34 files). **Next:** generate/shoot images per that file → Step 5 setup (accounts/keys) → Phase 0 scaffold. Product/hero/category/roots = **real photography before launch** (AI versions are build placeholders, swap before launch). Last commit: _none yet._
